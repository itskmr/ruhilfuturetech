...
const JobBoard: React.FC = () => {
  ...
  const [selectedWorkLevels, setSelectedWorkLevels] = React.useState<string[]>([]);
  ...
  // Flatten all cities for city dropdown
  const allIndiaCities = Object.values(indiaCities).flat();
  ...
  }, [selectedDepartment, selectedJobTypes, selectedSalaryRanges, selectedWorkLevels, searchTitle]);

  // Get unique departments from jobsData
  const departmentOptions = Array.from(new Set(jobsData.map(job => job.department)));
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-blue-100 to-indigo-100 flex flex-col relative overflow-hidden animate-fade-in">
//       {/* Animated Background Particles for Entire Page */}
//       <div className="absolute inset-0">
//         <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-gradient-to-r from-cyan-300 to-blue-300 rounded-full opacity-20 blur-3xl animate-pulse" />
//         <div className="absolute bottom-1/4 right-1/4 w-56 h-56 bg-gradient-to-r from-blue-300 to-cyan-300 rounded-full opacity-15 blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
//       </div>

//       {/* Header */}
//       <header className="bg-white/10 backdrop-blur-md px-4 md:px-10 py-4 flex items-center justify-between border-b border-white/20 relative z-10">
//         <div className="flex items-center gap-3">
//           <img src="https://cdn-icons-png.flaticon.com/512/5968/5968705.png" alt="Logo" className="w-8 h-8 rounded-full" />
//           <span className="font-bold text-xl tracking-wide text-white">Milao</span>
//         </div>
//         <nav className="flex-1 flex justify-center gap-8 text-base font-medium">
//           <a href="#" className="text-cyan-300 border-b-2 border-cyan-300 pb-1">Find Job</a>
//           <a href="#" className="text-white hover:text-cyan-200">Company Review</a>
//           <a href="#" className="text-white hover:text-cyan-200">Find Salaries</a>
//         </nav>
//         <div className="flex items-center gap-2">
//           <FaUserCircle className="text-2xl text-white" />
//           <span className="hidden md:inline text-white">Suhayol A. Nasim</span>
//         </div>
//       </header>
//       {/* Filters and Content */}
//       <main className="flex-1 flex flex-col md:flex-row bg-cyan-100 min-w-0 min-h-0 h-full relative z-10">
//         {/* Sidebar */}
//         <aside
//           className="w-full flex-shrink-0 border-r border-white/20 flex min-w-[120px] max-w-full md:max-w-xs hidden md:flex h-full min-h-0 bg-white/10 backdrop-blur-md"
//           style={{ width: sidebarWidth, transition: 'width 0.2s' }}
//         >
//           <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-lg shadow-lg p-6 w-full flex flex-col gap-8">
//             {/* Department/Team Filter */}
//             <div>
//               <h3 className="font-semibold mb-2 text-white">Department / Team</h3>
//               <select
//                 className="w-full px-3 py-2 rounded bg-white/10 text-white border border-white/30 focus:outline-none focus:border-cyan-300"
//                 value={selectedDepartment}
//                 onChange={e => setSelectedDepartment(e.target.value)}
//               >
//                 <option value="">All Departments</option>
...
//             {/* Job Type Filter */}
//             <div>
//               <h3 className="font-semibold mb-2 text-white">Job Type</h3>
//               <div className="flex flex-wrap gap-2">
//                 {['Full Time', 'Part Time', 'Internship', 'Remote', 'On-site', 'Hybrid'].map(type => (
...
//             {/* Salary Range Filter */}
//             <div>
//               <h3 className="font-semibold mb-2 text-white">Salary Range (LPA)</h3>
//               <div className="flex flex-col gap-2">
//                 {salaryLpaRanges.map(range => (
//                   <label key={range.label} className="flex items-center gap-2 text-sm text-white">
//                     <input
//                       type="checkbox"
//                       className="accent-cyan-500"
//                       checked={selectedSalaryRanges.includes(range.label)}
...
//             {/* Work Level / Seniority Filter */}
//             <div>
//               <h3 className="font-semibold mb-2 text-white">Work Level / Seniority</h3>
//               <div className="flex flex-wrap gap-2">
//                 {['Entry Level', 'Mid Level', 'Senior Level', 'Directors', 'VP or Above'].map(level => (
//                   <label key={level} className="flex items-center gap-2 text-sm text-white">
//                     <input
//                       type="checkbox"
//                       className="accent-cyan-500"
//                       checked={selectedWorkLevels.includes(level)}
...
//         {/* Sidebar slider (only on md+) */}
//         <div
//           className="hidden md:block cursor-col-resize bg-cyan-500/50 hover:bg-cyan-400 transition-colors duration-150"
//           style={{ width: 6, minWidth: 6, maxWidth: 12, cursor: 'col-resize' }}
//           onMouseDown={onSidebarMouseDown}
//         />
//         {/* Job List and Details with slider */}
...
//           {/* Job List */}
//           <div
//             className="bg-white/10 backdrop-blur-lg p-4 flex flex-col gap-2 min-w-[150px] max-w-full md:max-w-md overflow-y-auto h-full min-h-0 scrollbar-thin scrollbar-thumb-cyan-400/60 scrollbar-track-transparent animate-fade-in"
//             style={{ width: listWidth, transition: 'width 0.2s', flexShrink: 0 }}
//           >
//             {/* Responsive Search Bar for Job Title */}
//             <div className="flex flex-col sm:flex-row gap-2 mb-4 w-full">
...
//                 onChange={e => setSearchTitle(e.target.value)}
//                 placeholder="Search Job Title..."
//                 className="flex-1 px-3 py-2 rounded bg-white/10 text-white border border-white/30 placeholder-gray-300 focus:outline-none focus:border-cyan-300 focus:bg-opacity-15 transition-all duration-300 hover:scale-105"
//               />
//               <button
//                 type="button"
//                 className="px-4 py-2 bg-gradient-to-r from-cyan-400 to-blue-400 text-white rounded font-semibold hover:shadow-lg hover:shadow-cyan-400/30 transition-all duration-300 hover:scale-105"
//               >
//                 Search
//               </button>
//             </div>
//             {/* Job List Items */}
//             {filteredJobs.length === 0 && (
//               <div className="text-gray-300 text-center py-8 animate-fade-in">No jobs found.</div>
//             )}
//             {filteredJobs.map(job => (
//               <div
//                 key={job.id}
//                 className={`rounded-2xl border border-white/20 bg-white/10 backdrop-blur-lg shadow-lg p-4 mb-4 cursor-pointer transition-all min-w-0 animate-fade-in ${selectedJob.id === job.id ? 'ring-2 ring-cyan-300 text-white' : 'text-gray-100 hover:ring-1 hover:ring-cyan-300 hover:shadow-lg hover:shadow-cyan-400/30'}`}
//                 onClick={() => setSelectedJob(job)}
//               >
//                 <div className="flex items-center gap-3 mb-2">
//                   <div className="w-10 h-10 rounded-full bg-gradient-to-r from-cyan-400 to-blue-400 flex items-center justify-center text-white font-bold text-lg shadow-md">
//                     {job.title.charAt(0)}
//                   </div>
//                   <div className="min-w-0">
//                     <div className="font-semibold text-base truncate">{job.title}</div>
//                     <div className="text-xs text-gray-300 truncate">{job.location}</div>
//                   </div>
//                   <button className="ml-auto" onClick={e => { e.stopPropagation(); toggleLike(job.id); }}>
//                     {liked.includes(job.id) ? <FaHeart className="text-red-400" /> : <FiHeart className="text-gray-300 hover:text-cyan-300 transition-colors duration-200" />}
//                   </button>
//                 </div>
//                 <div className="flex gap-2 mb-1 flex-wrap">
//                   {job.tags.map((tag, idx) => (
//                     <span key={idx} className="px-2 py-1 rounded text-xs font-medium bg-cyan-500/20 text-cyan-200 whitespace-nowrap">{tag}</span>
//                   ))}
//                 </div>
...
//           {/* Job Details */}
//           <div className="flex-1 h-full flex flex-col min-w-0 min-h-0">
//             <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-lg shadow-lg p-6 h-full flex flex-col overflow-y-auto min-w-0 min-h-0 text-[#1E3A8A] animate-fade-in">
//               <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
//                 <div className="flex items-center gap-4 min-w-0">
//                   <div className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-400 to-blue-400 flex items-center justify-center text-white font-bold text-2xl shadow-md animate-bounce">
//                     {selectedJob.title.charAt(0)}
//                   </div>
//                   <div className="min-w-0">
//                     <h2 className="text-2xl font-bold mb-1 truncate">{selectedJob.title}</h2>
//                     <div className="text-cyan-300 font-semibold truncate">{selectedJob.company} <span className="text-gray-300">• {selectedJob.location}</span></div>
//                     <div className="text-xs text-gray-300 mt-1 truncate">{selectedJob.department && (<span>{selectedJob.department} | </span>)}Posted {selectedJob.posted} ago • {selectedJob.applicants} Applicants</div>
//                   </div>
//                 </div>
//                 <button
//                   className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-cyan-400 to-blue-400 hover:bg-blue-500 text-white font-bold rounded-lg shadow-md transition-all duration-300 hover:scale-105 text-lg"
//                   style={{ alignSelf: 'flex-start' }}
//                   onClick={() => alert('Application instructions coming soon!')}
//                 >
//                   Apply
...
//               </div>
//               <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
//                 <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center border border-white/20 transition-transform duration-300 hover:scale-105">
//                   <div className="text-xs text-gray-300">Experience</div>
//                   <div className="font-semibold text-[#1E3A8A]">{selectedJob.experience}</div>
//                 </div>
//                 <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center border border-white/20 transition-transform duration-300 hover:scale-105">
//                   <div className="text-xs text-gray-300">Work Level</div>
//                   <div className="font-semibold text-[#1E3A8A]">{selectedJob.workLevel}</div>
//                 </div>
//                 <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center border border-white/20 transition-transform duration-300 hover:scale-105">
//                   <div className="text-xs text-gray-300">Employee Type</div>
//                   <div className="font-semibold text-[#1E3A8A]">{selectedJob.employmentType}</div>
//                 </div>
//                 <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 text-center border border-white/20 transition-transform duration-300 hover:scale-105">
//                   <div className="text-xs text-gray-300">Offer Salary</div>
//                   <div className="font-semibold text-[#1E3A8A]">{selectedJob.salary}</div>
//                 </div>
//               </div>
//               <div className="mb-6">
//                 <h3 className="text-lg font-semibold mb-2 text-cyan-200">Overview</h3>
//                 <p className="text-[#1E3A8A] text-sm">{selectedJob.overview}</p>
//               </div>
//               <div className="mb-6">
//                 <h3 className="text-lg font-semibold mb-2 text-cyan-200">Key Responsibilities</h3>
//                 <ul className="list-disc pl-6 text-[#1E3A8A] text-sm space-y-1">
//                   {selectedJob.responsibilities && selectedJob.responsibilities.map((item, idx) => (
//                     <li key={idx}>{item}</li>
//                   ))}
//                 </ul>
//               </div>
//               <div className="mb-6">
//                 <h3 className="text-lg font-semibold mb-2 text-cyan-200">Required Qualifications</h3>
//                 <ul className="list-disc pl-6 text-[#1E3A8A] text-sm space-y-1">
//                   {selectedJob.requiredQualifications && selectedJob.requiredQualifications.map((item, idx) => (
//                     <li key={idx}>{item}</li>
//                   ))}
...
//               </div>
//               <div className="mb-6">
//                 <h3 className="text-lg font-semibold mb-2 text-cyan-200">Preferred Skills</h3>
//                 <ul className="list-disc pl-6 text-[#1E3A8A] text-sm space-y-1">
//                   {selectedJob.preferredSkills && selectedJob.preferredSkills.map((item, idx) => (
//                     <li key={idx}>{item}</li>
//                   ))}
...
//               </div>
//               <div className="mb-6">
//                 <h3 className="text-lg font-semibold mb-2 text-cyan-200">Application Deadline</h3>
//                 <p className="text-[#1E3A8A] text-sm">{selectedJob.applicationDeadline}</p>
//               </div>
//               <div className="mb-6">
//                 <h3 className="text-lg font-semibold mb-2 text-cyan-200">Equal Opportunity Statement</h3>
//                 <p className="text-[#1E3A8A] text-sm">{selectedJob.equalOpportunityStatement}</p>
//               </div>
//             </div>
//           </div>
//         </section>
